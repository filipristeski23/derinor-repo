...
export default function FeaturesSection() {
  return (
    <div id="features" className="w-full mt-[10rem]">
      <div className="max-w-[82.5rem] mx-auto my-0 flex-col items-center ">
        <div className="max-w-[62.5rem] mx-auto w-full shadow-[0_4px_8px_rgba(0,0,0,0.1)] rounded-b-[1rem]">
          <div className="w-full h-[28.75rem] bg-[#3D6BC6] rounded-tl-[1rem] rounded-tr-[1rem] rounded-bl-0 rounded-br-0 relative flex justify-end ">
            <img
              src={DesktopReports}
          ...
          <div className="w-full pt-[3rem] pl-[3rem] pb-[3rem] bg-[#F8FAFD] rounded-tl-0 rounded-tr-0 rounded-bl-[1rem] rounded-br-[1rem]">
            <div className="flex flex-col gap-[1.5rem]">
              <h2 className="text-[2rem] text-[#23272A] font-semibold leading-[2.5rem]">
                As many projects as you need
              </h2>
              <h3 className="text-[1.25rem] text-[#23272A] font-medium leadin-[1.75rem]">
        ...
        <div className="max-w-[62.5rem] mx-auto w-full flex gap-[1.5rem] mt-[3rem]">
          <div className="max-w-[33.5rem] w-full ">
            <div className="w-full h-[28.75rem] bg-[#3D6BC6] rounded-tl-[1rem] rounded-tr-[1rem] rounded-bl-0 rounded-br-0 relative flex justify-start overflow-hidden">
              <img
                src={SetBranches}
                alt="Projects Feature"
            ...
            <div className="w-full pt-[2rem] pl-[1.5rem] pb-[2rem] bg-[#F8FAFD] rounded-tl-0 rounded-tr-0 rounded-bl-[1rem] rounded-br-[1rem] shadow-[0_4px_8px_rgba(0,0,0,0.1)]">
              <div className="flex flex-col gap-[1.5rem]">
                <h2 className="text-[2rem] text-[#23272A] font-semibold leading-[2.5rem]">
                  Set Branches
                </h2>
