      ...
      <div className="flex flex-col gap-[2rem]">
        <div className="flex flex-col gap-[1rem]">
          <input
            ...
            required
            className="w-full h-[2.5rem] px-[1rem] bg-[#EEF2F6] rounded-[0.5rem] outline-none"
          />
          <input
            type="text"
            name="projectName"
          ...
          <textarea
            ...
            required
            className="w-full h-[8rem] p-[1rem] bg-[#EEF2F6] rounded-[0.5rem] outline-none resize-none"
          />
        </div>
